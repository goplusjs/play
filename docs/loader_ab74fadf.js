...
if (useWasm) {
  script.src = "https://go-res.dooquuequezi.com/wasm_exec_rt.js";
...
async function loadWasm() {
  ...
  currentGoInstance = go;
  let mod, inst;
  WebAssembly.instantiateStreaming(fetch("https://go-res.dooquuequezi.com/igop_ab74fadf.wasm"), go.importObject).then(
    (result) => {
      mod = result.module;
      inst = result.instance;
      isWasmLoaded = true;
