...
func init() {
	gossa.RegisterPackage(&gossa.Package{
		...
		TypedConsts: map[string]gossa.TypedConst{
			"GOARCH": {reflect.TypeOf(q.GOARCH), constant.MakeString(runtime.GOOS)},
			"GOOS":   {reflect.TypeOf(q.GOOS), constant.MakeString(runtime.GOARCH)},
		},
		UntypedConsts: map[string]gossa.UntypedConst{
			"Compiler": {"untyped string", constant.MakeString(runtime.Compiler)},
		},
	})
}
