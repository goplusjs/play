...
// func (*template.Error).Error() string
func execmErrorError(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret := args[0].(*template.Error).Error()
	p.Ret(1, ret)
}
...
func init() {
	I.RegisterConsts(
		I.Const("ErrAmbigContext", reflect.Int, template.ErrAmbigContext),
		I.Const("ErrBadHTML", reflect.Int, template.ErrBadHTML),
		I.Const("ErrBranchEnd", reflect.Int, template.ErrBranchEnd),
		I.Const("ErrEndContext", reflect.Int, template.ErrEndContext),
		I.Const("ErrNoSuchTemplate", reflect.Int, template.ErrNoSuchTemplate),
		I.Const("ErrOutputContext", reflect.Int, template.ErrOutputContext),
		I.Const("ErrPartialCharset", reflect.Int, template.ErrPartialCharset),
		I.Const("ErrPartialEscape", reflect.Int, template.ErrPartialEscape),
		I.Const("ErrPredefinedEscaper", reflect.Int, template.ErrPredefinedEscaper),
		I.Const("ErrRangeLoopReentry", reflect.Int, template.ErrRangeLoopReentry),
		I.Const("ErrSlashAmbig", reflect.Int, template.ErrSlashAmbig),
		I.Const("OK", reflect.Int, template.OK),
	)
	I.RegisterTypes(
		I.Type("CSS", qspec.TyString),
		I.Rtype(reflect.TypeOf((*template.Error)(nil))),
		I.Type("ErrorCode", qspec.TyInt),
		I.Type("HTML", qspec.TyString),
		I.Type("HTMLAttr", qspec.TyString),
		I.Type("JS", qspec.TyString),
		I.Type("JSStr", qspec.TyString),
		I.Type("Srcset", qspec.TyString),
		I.Rtype(reflect.TypeOf((*template.Template)(nil))),
		I.Type("URL", qspec.TyString),
	)
	I.RegisterFuncs(
